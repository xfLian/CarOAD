...
@interface OrderDetailsAddressCell()
...
@implementation OrderDetailsAddressCell
...
- (void)changeState {
    ...
    if (adapter.cellType == kOrderDetailsAddressCellNoDataType) {
