...
@implementation MyOrderDetailsData
...
- (instancetype)timeModelWithData:(id)data; {
    ...
    MyOrderDetailsData *newModel = [[[self class] alloc] init];
    ...
    newModel.demandInfo         = model.demandInfo;
    newModel.demandImgName      = model.demandImgName;
    ...
    newModel.publicDate         = model.publicDate;
    ...
    newModel.shopName           = model.shopName;
    newModel.shopLinkman        = model.shopLinkman;
    newModel.mobile             = model.mobile;
    newModel.shopLinkmanImg     = model.shopLinkmanImg;
    newModel.shopAuth           = model.shopAuth;
    newModel.demandState        = model.demandState;
    newModel.msgCount           = model.msgCount;
    newModel.clickNum           = model.clickNum;
