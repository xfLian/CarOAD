...
@implementation AddJobIntensionViewModel

+ (void)requestPost_addWorkExpNetWorkingDataWithParams:(NSDictionary *)params
    ...
    NSString *urlString = MYPostClassUrl(CLASS_USER, ADD_WORK_EXP);
