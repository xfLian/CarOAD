//
//  OADJobExperiencesListViewController.m
//  CarOAD
//
...
#import "CreateCVJobexperiencesRootModel.h"
...
@interface OADJobExperiencesListViewController ()
...
@implementation OADJobExperiencesListViewController
...
- (void)buildSubView {
    ...
    [JobExperiencesListCell registerToTableView:self.tableView];
...
- (void) buttonEvent:(UIButton *)sender {
    ...
    __weak OADJobExperiencesListViewController *weakSelf = self;
    CreateCVJobexperiencesData *tmpData = [CreateCVJobexperiencesData new];
    OADAddJobExperiencesViewController *viewController = [OADAddJobExperiencesViewController new];
...
- (void) loadNewData {
    ...
    [JobExperiencesListViewModel requestPost_getWorkExpNetWorkingDataWithParams:self.params success:^(id info, NSInteger count) {
       
        CreateCVJobexperiencesRootModel *rootModel  = [[CreateCVJobexperiencesRootModel alloc] initWithDictionary:info];
        
        NSMutableArray *dataArray = [[NSMutableArray alloc] init];
        
        if (rootModel.data.count > 0) {
            
            for (CreateCVJobexperiencesData *tmpData in rootModel.data) {
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JobExperiencesListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JobExperiencesListCell" forIndexPath:indexPath];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    __weak OADJobExperiencesListViewController *weakSelf = self;
    CreateCVJobexperiencesData *tmpData = self.datasArray[indexPath.section];
    OADAddJobExperiencesViewController *viewController = [OADAddJobExperiencesViewController new];
    tmpData.CVId = self.cvId;
    viewController.data = tmpData;
    viewController.addJobExpSucces = ^(BOOL isAddJobSuccess) {
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"提示" message:@"是否删除工作经验？" preferredStyle:UIAlertControllerStyleAlert];
        [alertController addAction:[UIAlertAction actionWithTitle:@"取消" style:UIAlertActionStyleCancel handler:nil]];
        [alertController addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
            
            CreateCVJobexperiencesData *tmpData = weakSelf.datasArray[indexPath.section];
            NSDictionary *params = @{@"workExpId" : tmpData.workExpId};
            [JobExperiencesListViewModel requestPost_deleteWorkExpNetWorkingDataWithParams:params success:^(id info, NSInteger count) {
