...
@implementation MyDeliverDetailsViewModel
...
+ (void)requestPost_getPostInfoNetWorkingDataWithParams:(NSDictionary *)params
    ...
    NSString *urlString = MYPostClassUrl(CLASS_JOB, GET_POST_INFO);
...
+ (void)requestPost_sendCVNetWorkingDataWithParams:(NSDictionary *)params
    ...
    NSString *urlString = MYPostClassUrl(CLASS_JOB, SEND_CV);
