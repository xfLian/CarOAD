...
@interface CommunityMoreImageCell()
...
@implementation CommunityMoreImageCell
...
- (void) layoutSubviews {
    ...
    for (int i = 0; i < self.imageViewArray.count; i++) {
        ...
        imageView.frame = CGRectMake(i *((self.width - 44 *Scale_Width) / 3 + 10 *Scale_Width), 0, (self.width - 44 *Scale_Width) / 3, Image_More_Height);
        
    }
    
    self.otherBackView.frame = CGRectMake(12 *Scale_Width, self.imageBackView.y + self.imageBackView.height, self.width - 24 *Scale_Width, 60 *Scale_Height);
