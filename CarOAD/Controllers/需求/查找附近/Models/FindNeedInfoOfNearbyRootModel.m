//
//  FindNeedInfoOfNearbyRootModel.m
//  CarOAD
//
...
@implementation FindNeedInfoOfNearbyRootModel
...
- (void)setValue:(id)value forKey:(NSString *)key {
    ...
    if ([key isEqualToString:@"data"] && [value isKindOfClass:[NSArray class]]) {
        ...
        for (NSDictionary *data in tmp) {
            ...
            FindNeedInfoOfNearbyData *service = [[FindNeedInfoOfNearbyData alloc] initWithDictionary:data];
